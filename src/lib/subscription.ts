...
// الأسعار بالريال السعودي وغير شاملة ضريبة القيمة المضافة.
...
/** الأسعار بالريال السعودي (غير شاملة الضريبة). */
export const PRICING = {
  monthly: 100,
  /** السنوي 1000 بدلاً من 1200 (خصم 200 ريال). */
  yearly: 1000,
  yearlyBefore: 1200,
  yearlyDiscount: 200,
  /** ضريبة القيمة المضافة السعودية الافتراضية؛ ويمكن تعديلها من الإعدادات للفواتير. */
  vatRate: 15,
} as const;
